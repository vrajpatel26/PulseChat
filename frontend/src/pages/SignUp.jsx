        ...
        <div className='w-full h-[100vh] bg-slate-200 flex items-center justify-center'>
            ...
            <div className='w-full max-w-[500px] h-[600px] bg-white rounded-lg shadow-gray-200 shadow-lg flex flex-col gap-[40px]'>
                ...
                <form className='w-full flex flex-col gap-[20px] items-center'>
                    <input type="text" placeholder='username' className='w-[90%] h-[50px] outline-none border-2 border-[#20c7ff] px-[20px] py-[10px] bg-white rounded-lg shadow-gray-200 shadow-lg  text-gray-400 text-[19px] ' />

                    <input type="email" placeholder='email' className='w-[90%] h-[50px] outline-none border-2 border-[#20c7ff] px-[20px] py-[10px] bg-white rounded-lg shadow-gray-200 shadow-lg  text-gray-400 text-[19px] ' />
                    ...
                    <button className='w-[130px] border-2 border-none px-[20px] py-[10px] bg-[#20c7ff] rounded-lg  shadow-gray-200 shadow-lg  mt-[10px] hover:bg-[#04ace4] font-medium'>Sign Up</button>
